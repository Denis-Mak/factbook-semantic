...
public class JavaDemo implements Serializable {
    ...
    private void generateData(JavaSparkContext sc) {
        ...
        JavaRDD<Sale> salesRDD = productsRDD
                .filter(product -> product.getParents().size() == 2)
                .flatMap(product -> {
    ...
    private void compute(JavaSparkContext sc) {
        ...
        JavaRDD<Summary> summariesRDD = allSalesRDD
                ...
                .map(input -> new Summary(input._1(), input._2()));
    ...
    private void showResults(JavaSparkContext sc) {
        JavaPairRDD<Integer, Summary> summariesRdd = javaFunctions(sc)
                ...
                .keyBy((Function<Summary, Integer>) Summary::getProduct);

        JavaPairRDD<Integer, Product> productsRdd = javaFunctions(sc)
                .cassandraTable("java_api", "products", mapRowTo(Product.class))
                .keyBy((Function<Product, Integer>) Product::getId);
